...
- `/Users/nataly/Documents/github/observatory/`: Strategic planning, research, and documentation.
...
- **UI/UX Confidence:** Before touching the frontend, verify if existing mockups or briefs exist (often found in `/Users/nataly/Documents/github/observatory/mockups/`). If the current UI is broken, propose a systematic refactor or rewrite rather than patching bugs blindly.
