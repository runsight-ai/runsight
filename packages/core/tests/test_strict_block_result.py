"""
Strict BlockResult typing without auto-coercion or string-protocol shims.

These tests assert strict result typing:
...
class TestWorkflowStateRejectsRawStrings:
    """WorkflowState must reject raw strings in results."""
...
class TestBlockResultBackwardCompatRemoved:
    ...
    def test_block_result_has_no_len(self):
        ...
        assert "__len__" not in BlockResult.__dict__, (
            "BlockResult still defines __len__ — this backward-compat method should be removed"
        )
    ...
    def test_block_result_has_no_contains(self):
        ...
        assert "__contains__" not in BlockResult.__dict__, (
            "BlockResult still defines __contains__ — this backward-compat method should be removed"
        )
    ...
    def test_block_result_has_no_custom_eq(self):
        ...
        assert br != "hello", (
            ...
            "the custom __eq__ should be removed"
        )
