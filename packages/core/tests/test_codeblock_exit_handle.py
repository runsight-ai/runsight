...
class TestExitHandleExtractedFromDictResult:
    @pytest.mark.asyncio
...
class TestMissingExitHandleReturnsNone:
    @pytest.mark.asyncio
...
class TestPlainStringResultHasNoExitHandle:
    @pytest.mark.asyncio
...
class TestLoopBlockBreaksOnCodeExit:
    @pytest.mark.asyncio
...
class TestCodeFailureReturnsErrorExitHandle:
    @pytest.mark.asyncio
