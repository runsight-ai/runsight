...
class TestLoopUsesStateSnapshot:
...
class TestLoopInnerBlocksGetFreshContext:
...
class TestLoopCarryContextFlows:
...
class TestLoopRoundTrackingMetadata:
...
class TestNestedLoopsAvoidContextLeak:
