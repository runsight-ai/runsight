...
_LOW_THRESHOLD_YAML = eval_fixture_text("eval-runner-low-threshold.yaml")
_TWO_BLOCK_YAML = eval_fixture_text("eval-runner-two-block.yaml")
_NO_EXPECTED_CASE_YAML = eval_fixture_text("eval-runner-no-expected-case.yaml")
_NO_FIXTURES_NO_EXECUTOR_YAML = eval_fixture_text("eval-runner-no-fixtures-no-executor.yaml")
