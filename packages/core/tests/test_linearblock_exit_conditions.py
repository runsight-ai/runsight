...
class TestContainsExitConditionMatch:
    @pytest.mark.asyncio
...
class TestRegexExitConditionMatch:
    @pytest.mark.asyncio
...
class TestLoopBlockBreaksOnExitCondition:
    @pytest.mark.asyncio
...
class TestExplicitExitHandlePrecedence:
    @pytest.mark.asyncio
...
class TestMultipleExitConditionsUseFirstMatch:
    @pytest.mark.asyncio
