...
// .select trigger — control-height-sm, border-default, border-hover, surface-tertiary, text-primary
// .dropdown-menu popup — surface-overlay, elevation-overlay-shadow
