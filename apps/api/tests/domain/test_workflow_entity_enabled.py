"""WorkflowEntity explicit enabled field.

These tests cover explicit entity fields rather than permissive extra data.
The `enabled` field must be declared explicitly instead of being accepted only
through permissive extra-field handling.
