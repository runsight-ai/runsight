"""
Orphan removal: /api/tasks and /api/steps must not exist.

These tests assert the routes return 404 and the router files are gone.
"""
...
class TestOrphanedRoutersRemoved:
    def test_get_tasks_returns_404(self):
        """GET /api/tasks must not exist after orphan route cleanup."""
    ...
    def test_get_steps_returns_404(self):
        """GET /api/steps must not exist after orphan route cleanup."""
