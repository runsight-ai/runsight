"""Normalize error responses from HTTPException to RunsightError.
...
class TestNewErrorSubclasses:
    """Domain-specific errors must inherit the shared RunsightError contract."""
...
class TestNoHTTPExceptionInRouters:
    """Router files should raise domain errors instead of HTTPException."""
