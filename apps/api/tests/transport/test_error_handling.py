...
Response-shape tests verify {"error", "error_code", "status_code"}. Source
inspection verifies manual JSONResponse/HTTPException patterns stay removed.
"""
...
def test_no_http_exception_in_runs():
    ...
    assert "HTTPException(" not in source, (
        "runs.py contains HTTPException(...) — run errors must stay mapped through the "
