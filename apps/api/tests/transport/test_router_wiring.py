"""Router wiring: POST /runs triggers execution_service.launch_execution().
...
def _make_mock_run(run_id="run_new"):
    mock_run = Mock()
    mock_run.id = run_id
    mock_run.workflow_id = "wf_router_launch_execution"
    mock_run.workflow_name = "Router launch execution workflow"
...
class TestPostRunsTriggersExecution:
    def test_post_runs_calls_launch_execution(self):
        ...
        try:
            ...
            assert call_args[0][1] == "wf_router_launch_execution"  # workflow_id
