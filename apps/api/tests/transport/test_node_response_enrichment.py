"""RunNodeResponse enrichment fields.

Transport schema coverage for output, soul_id, model_name, eval_score,
eval_passed, and eval_results in:
...
def _make_mock_node(
    *,
    node_id: str = "step_1",
    run_id: str = "run_node_enrichment",
