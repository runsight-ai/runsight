"""Run list response field contract."""
...
def _make_mock_run(
    run_id: str = "run_list_contract",
    *,
    workflow_id: str = "wf_run_list_contract",
...
def test_runs_list_keeps_source_and_branch_filters_unchanged_with_metrics_fields():
    run = _make_mock_run(
        run_id="run_filtered",
        source="manual",
        branch="main",
