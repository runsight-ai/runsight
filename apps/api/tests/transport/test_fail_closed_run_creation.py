"""Fail closed when the execution runtime is unavailable.
...
def _make_mock_run(run_id: str = "run_fail_closed"):
    mock_run = Mock()
    mock_run.id = run_id
    mock_run.workflow_id = "wf_fail_closed_creation"
    mock_run.workflow_name = "Fail closed creation workflow"
...
def workflow_repo():
    workflow = Mock()
    workflow.id = "wf_fail_closed_creation"
    workflow.name = "Fail closed creation workflow"
    repo = Mock()
