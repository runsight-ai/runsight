...
async def get_run_eval(run_id: str, eval_service: EvalService = Depends(get_eval_service)):
...
async def get_soul_eval_history(
    soul_id: str, eval_service: EvalService = Depends(get_eval_service)
):
