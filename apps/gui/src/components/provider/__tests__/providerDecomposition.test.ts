/**
 * ProviderSetup decomposition coverage.
 *
 * Source-reading pattern: verify structural properties by reading source files.
 *
 * Behavior covered:
 * - ProviderSetup decomposed into wizard sub-components
 * - Form state and API calls live in custom hooks
 * - Sub-components stay within the expected line budget
 * - ProviderSetup remains exported for existing consumers
 */
...
// ===========================================================================
// 1. New hook files exist
// ===========================================================================

describe("New hook files exist", () => {
...
// ===========================================================================
// 2. useProviderSetupForm hook structure
// ===========================================================================

describe("useProviderSetupForm hook structure", () => {
...
// ===========================================================================
// 3. useProviderConnection hook structure
// ===========================================================================

describe("useProviderConnection hook structure", () => {
...
// ===========================================================================
// 4. ProviderSetup main component line count
// ===========================================================================

describe("ProviderSetup main component ≤80 lines", () => {
...
// ===========================================================================
// 5. ProviderSetup useState count
// ===========================================================================

describe("ProviderSetup main component has ≤5 useState calls", () => {
...
// ===========================================================================
// 6. ProviderSetup still exported
// ===========================================================================

describe("ProviderSetup still exported", () => {
