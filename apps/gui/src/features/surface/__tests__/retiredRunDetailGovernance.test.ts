/**
 * Governance: retired run-detail surface boundary.
 *
 * Owner: GUI Surface.
 * Boundary: run-detail canvas utilities and inspector wiring stay in
 * features/surface, not in the retired features/runs detail tree.
 * Exit criteria: remove once the surface/runs split is enforced by workspace
 * import boundaries.
 */
...
describe("Governance: retired run-detail surface boundary", () => {
