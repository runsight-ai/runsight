/**
 * Governance: surface workspace rename and consolidation boundary.
 *
 * Owner: GUI Surface.
 * Boundary: the live workflow surface stays in features/surface, retired
 * features/canvas entrypoints stay deleted, and shared run-table UI remains
 * owned by packages/ui.
 * Exit criteria: remove once the repo layout migration is complete and these
 * boundaries are enforced by workspace ownership tooling.
 */
