...
const FLOATING_NODE_SVGS = [
  <svg key="1" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="var(--interactive-default)" strokeWidth="1.5">
    <circle cx="12" cy="12" r="8" />
    <circle cx="12" cy="12" r="3" />
  </svg>,
  <svg key="2" width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="var(--interactive-default)" strokeWidth="1.5">
    <rect x="4" y="4" width="16" height="16" rx="2" />
    <path d="M8 12h8M12 8v8" />
  </svg>,
  <svg key="3" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="var(--info-9)" strokeWidth="1.5">
  ...
  <svg key="6" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="var(--interactive-default)" strokeWidth="1.5">
...
export function Component() {
  return (
    <div className="relative min-h-screen bg-[var(--surface-primary)] text-[var(--text-primary)] overflow-x-hidden">
      {/* Background Grid */}
      <div
      ...
      {FLOATING_NODE_SVGS.map((svg, i) => {
        ...
        return (
          <div
            key={i}
            className="absolute flex items-center justify-center rounded-[6px] bg-[var(--surface-secondary)] border border-[var(--border-default)] opacity-60"
            style={{
              width: pos.size,
              height: pos.size,
      ...
      <main className="relative z-10 min-h-screen flex flex-col items-center justify-center px-8 py-32">
        ...
        <div className="flex items-center gap-[12px] mb-8">
          ...
          <span className="text-[13px] font-semibold tracking-[0.08em] uppercase text-[var(--text-primary)]">
            RUNSIGHT
          </span>
        </div>
        ...
        <div className="text-center max-w-[720px]">
          <h1 className="text-2xl font-semibold leading-[1.3] tracking-[-0.02em] text-[var(--text-primary)] mb-6">
        ...
        <div className="grid grid-cols-3 gap-6 mt-16 max-w-[880px] max-md:grid-cols-2 max-md:gap-4">
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 flex items-center justify-center bg-[var(--surface-secondary)] border border-[var(--border-default)] rounded-lg text-primary">
              <svg
                viewBox="0 0 24 24"
                fill="none"
                stroke="currentColor"
            ...
            <span className="text-[14px] font-medium text-[var(--text-primary)]">Visual Canvas</span>
            <span className="text-[12px] text-[var(--text-muted)] leading-snug">Drag-and-drop workflow builder</span>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 flex items-center justify-center bg-[var(--surface-secondary)] border border-[var(--border-default)] rounded-lg text-primary">
              <svg
            ...
            <span className="text-[14px] font-medium text-[var(--text-primary)]">Git-Native</span>
            <span className="text-[12px] text-[var(--text-muted)] leading-snug">YAML workflows, versioned by default</span>
          </div>
          <div className="flex flex-col items-center text-center gap-3">
            <div className="w-12 h-12 flex items-center justify-center bg-[var(--surface-secondary)] border border-[var(--border-default)] rounded-lg text-primary">
              <svg
            ...
            <span className="text-[14px] font-medium text-[var(--text-primary)]">Multi-Provider</span>
            <span className="text-[12px] text-[var(--text-muted)] leading-snug">OpenAI, Anthropic, local models</span>
          </div>
        </div>
      </main>
      ...
      {/* Footer */}
      <footer
        className="absolute bottom-6 left-1/2 -translate-x-1/2 text-[12px] text-[var(--text-muted)] z-10"
      >
