...
const RUN_TABLE_ROW_CLASS = "h-[var(--control-height-lg)] cursor-pointer hover:bg-surface-hover";
const RUN_TABLE_CELL_CLASS = "border-b-0 px-2.5 py-0";
const RUN_TABLE_STATUS_CELL_CLASS = "relative w-9 border-b-0 px-0 py-0 text-center";
const RUN_TABLE_REGRESSION_STRIPE_CLASS =
