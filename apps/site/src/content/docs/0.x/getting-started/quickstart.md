---
title: Quickstart
description: Get Runsight running and create your first AI agent workflow in
  under 5 minutes.
slug: 0.x/getting-started/quickstart
---
...
2. **write\_summary** — another LLM call using the `writer` soul
3. **quality\_review** — a gate block that evaluates the summary output
