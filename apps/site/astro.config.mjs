			...
			sidebar: [
				...
				},
				{
					...
					items: [
						...
						{
							label: 'Transitions & Routing',
							slug: 'workflows/transitions-and-routing',
						},
						{ label: 'Sub-Workflows', slug: 'workflows/sub-workflows' },
						{ label: 'Loops', slug: 'workflows/loops' },
						{
							label: 'YAML DX Shortcuts',
							slug: 'workflows/yaml-dx-shortcuts',
						},
					],
				},
				{
				...
				},
				{
					...
					items: [
						...
						{
							label: 'Dispatch & Delegate',
							slug: 'tools/dispatch-and-delegate',
						},
					],
				},
				{
					...
					items: [
						{
							...
							slug: 'execution/running-workflows',
						},
						{
							label: 'Git Integration',
							slug: 'execution/git-integration',
						},
						{ label: 'Fork Recovery', slug: 'execution/fork-recovery' },
						{
							label: 'Budget & Limits',
							slug: 'execution/budget-and-limits',
						},
				...
				},
				{
					...
					items: [
						...
						{
							label: 'Transform Hooks',
							slug: 'evaluation/transform-hooks',
						},
						{
							label: 'Eval Test Harness',
							slug: 'evaluation/eval-test-harness',
						},
				...
				},
				{
					...
					items: [
						...
						{ label: 'Fallback', slug: 'configuration/fallback' },
					...
					items: [
						{
							...
							slug: 'visual-builder/canvas-overview',
						},
						{
							label: 'Canvas Modes',
							slug: 'visual-builder/canvas-modes',
						},
						{ label: 'YAML Editor', slug: 'visual-builder/yaml-editor' },
						{
							label: 'Run Detail View',
							slug: 'visual-builder/run-detail-view',
						},
					],
				},
				{
					...
					items: [
						{
							label: 'YAML Schema Reference',
							slug: 'reference/yaml-schema-reference',
						},
						{
							label: 'Block Type Reference',
							slug: 'reference/block-type-reference',
						},
						{
							label: 'Assertion Reference',
							slug: 'reference/assertion-reference',
						},
