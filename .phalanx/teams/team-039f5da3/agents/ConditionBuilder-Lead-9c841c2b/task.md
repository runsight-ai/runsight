...
## Your Task
Team task: Build Flow 3.02: Condition Builder (Inspector Conditions Tab) for Phalanx GUI canvas. Enhanced condition builder: Simple mode (IF/THEN/ELSE dropdowns), Expression mode (Jinja2 textarea with autocomplete), Python mode (Monaco code editor). Mode selector, validation indicator. Reference .agora/mockups/flow-3-create-run-engineer/02-condition-builder/. Write E2E tests. Reviewer gates.

Workers:
- ConditionBuilder-UI-1e691cdc (role=coder, name=ConditionBuilder-UI)
- ConditionBuilder-E2E-7e4c71fd (role=coder, name=ConditionBuilder-E2E)
- ConditionBuilder-Reviewer-bc3dc596 (role=reviewer, name=ConditionBuilder-Reviewer)

Team ID: team-039f5da3
