...
## Your Task
Rename all instances of 'phalanx', 'Phalanx', and 'PHALANX' to 'runsight', 'Runsight', and 'RUNSIGHT' across the entire codebase. Including filenames and directory names (e.g. libs/core/src/phalanx_core -> runsight_core). Update pyproject.toml and other config files accordingly.
