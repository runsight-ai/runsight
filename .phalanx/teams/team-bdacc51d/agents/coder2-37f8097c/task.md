...
## Your Task
Rename all instances of the word 'phalanx' to 'runsight' (preserving case) inside the 'apps/gui', 'apps/cli', and '.agora' directories. This includes renaming any directories or files that contain the word 'phalanx'. Update package.json and Markdown files.
