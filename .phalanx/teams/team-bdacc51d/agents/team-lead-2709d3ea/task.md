...
## Your Task
Team task: Rename all instances of 'phalanx', 'Phalanx', and 'PHALANX' to 'runsight', 'Runsight', and 'RUNSIGHT' across the entire codebase.

Workers:
- lead-245efb37 (role=architect, name=lead)
- coder1-e368102e (role=coder, name=coder1)
- coder2-37f8097c (role=coder, name=coder2)
- coder3-ef64dab3 (role=coder, name=coder3)
- reviewer-8e2c537b (role=reviewer, name=reviewer)

Team ID: team-bdacc51d
