...
## Your Task
Team task: Build Flow 2 screens for Phalanx GUI: Dashboard (populated state), New Workflow Modal, Canvas (empty + edit with ReactFlow). Reference mockups in .agora/mockups/flow-2-create-run-pm/. Use existing React Query hooks, Zod schemas, and shared components. Kimi builds screens, Sonnet writes E2E tests, Gemini reviews. Agents work in parallel; reviewer gates the merge.

Workers:
- Flow2-UI-a7d74f84 (role=coder, name=Flow2-UI)
- Flow2-E2E-0273f71d (role=coder, name=Flow2-E2E)
- Flow2-Reviewer-f503f91a (role=reviewer, name=Flow2-Reviewer)

Team ID: team-80763ca5
