...
## Your Task
Rename all instances of 'phalanx', 'Phalanx', and 'PHALANX' to 'runsight', 'Runsight', and 'RUNSIGHT' across the entire codebase. Update package names, file contents, imports, and variables in Python, TypeScript, markdown, and config files (like pyproject.toml, package.json). Rename directories or files named 'phalanx' to 'runsight'. Update .agora docs to refer to Runsight.
