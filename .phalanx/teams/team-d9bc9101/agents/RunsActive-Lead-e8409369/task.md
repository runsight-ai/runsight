...
## Your Task
Team task: Build Flow 4.01: Runs Active Tab for Phalanx GUI. Active runs table with status badges, duration, cost, agent count. Tab bar [Active | History]. Route: /runs?tab=active. Reference .agora/mockups/flow-4-monitor-runs/01-runs-active/. Write E2E tests. Reviewer gates.

Workers:
- RunsActive-UI-dc2b1a30 (role=coder, name=RunsActive-UI)
- RunsActive-E2E-e4e87426 (role=coder, name=RunsActive-E2E)
- RunsActive-Reviewer-3b0e276a (role=reviewer, name=RunsActive-Reviewer)

Team ID: team-d9bc9101
